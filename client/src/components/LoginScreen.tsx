        ...
        <GlassPane className="p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full min-h-[44px] bg-white border border-slate-200 text-slate-700 font-medium py-3 rounded-xl shadow-sm hover:bg-slate-50 hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
            >
