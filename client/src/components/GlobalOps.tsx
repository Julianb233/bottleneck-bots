    ...
    <div className="h-full flex flex-col gap-6 overflow-y-auto p-1">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 shrink-0">
        <GlassPane className="p-4 flex items-center gap-4">
          ...
          <div>
            <p className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">Sub-accounts</p>
        ...
        <GlassPane className="p-4 flex items-center gap-4">
          ...
          <div>
            <p className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">Active Agents</p>
        ...
        <GlassPane className="p-4 flex items-center gap-4">
          ...
          <div>
            <p className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">Tasks Pending</p>
        ...
        <GlassPane className="p-4 flex items-center gap-4">
          ...
          <div>
            <p className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">Issues</p>
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between items-start relative mb-3">
                  ...
                  {agent && (
                    <span className={`text-[11px] font-bold px-2 py-1 rounded-lg border uppercase tracking-wider ${getStatusColor(agent.status)}`}>
                      {agent.status}
                    </span>
                  )}
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="mt-4 pt-4 border-t border-slate-100 flex justify-between items-center">
                    <span className="text-[11px] font-bold text-indigo-500 opacity-0 group-hover:opacity-100 transition-opacity uppercase tracking-wide">Enter Terminal</span>
